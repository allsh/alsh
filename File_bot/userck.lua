...
if result.id_ then 
local keko2 = database:get('tshake:'..bot_id.."keko:Userr"..result.id_)
if not result.username_ then 
if keko2 then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه : @"..keko2, 1, 'html')
database:del('tshake:'..bot_id.."keko:Userr"..result.id_) 
end
end
...
database:set('tshake:'..bot_id.."keko:Userr"..result.id_, result.username_) 
end
end
end
